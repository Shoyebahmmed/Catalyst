...
export default function Generate_Monthly_Report ({ orderHistory, setIsOverLayOn, isOverLayOn }) {
  ...
  return (
    <View style={styles.outerContainer}>
      <ScrollView style={styles.container}>
        <Text style={styles.title}>Monthly Sales Report for {selectedDateString}</Text>
